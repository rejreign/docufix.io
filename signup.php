...
>>>>>>> parent of c5f176a... made changes to policy page
            ...
            <form class="form-align" method="POST" action="">
                ...
                <div class="form-group col-md-4 col-lg-8">
                    <input type="text" class="form-control" id="name" name="fullname" placeholder="Full Name" pattern="[a-zA-Z]{1,}" data-toggle="tooltip" data-placement="bottom" title="Enter Your Full Name" required><span class="error"></span>
                </div>
